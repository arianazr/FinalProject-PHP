...
<div class="container-prchs">
    ...
    <div class="container-rightP"> 
        <form action="insertPurch.php" method="post" class="container-right">
            <input type="text" class="profile__input" name="user_id" id="user_id" value="<?php echo $_SESSION["id"]?>">
            <input type="text" class="profile__input" name="product_id" id="product_id" value="<?php echo $user_data["id"]?>">
            <input type="number" class="profile__input" name="amount" id="amount">
